...
function XMinimap.OnEvent()
	...
	local _, err = loadfile("Interface/Addons/XMinimap/Locales/"..lang..".lua")
	if err then
		Print("|cff993333XMinimap can't find translation, ENUS.lua loaded.|r")
		dofile("Interface/Addons/XMinimap/Locales/ENUS.lua")
	else
		dofile("Interface/Addons/XMinimap/Locales/"..lang..".lua")
	end
	if XBARVERSION and XBARVERSION>=1.51 then
		XAddon_Register(
		{gui={{
	...
	XMinimap.Var()
	Print("|cffFFBB55XMinimap %s|r %s |cffFFBB55/xm|r %s", XMinimap.version, XMinimap.Lang["Load"], XMinimap.Lang["ToConfig"])
end
...
function XMinimap.Var()
	...
	if XMinimapSet["Enable"] then
		...
		if XMinimapSet["Style"]>1 then
			...
			MinimapRimFrameTexture1:SetTexture("Interface/AddOns/XMinimap/Textures/"..XMinimapSkin[XMinimapSet["Style"]].."/rim1")
			MinimapRimFrameTexture2:SetTexture("Interface/AddOns/XMinimap/Textures/"..XMinimapSkin[XMinimapSet["Style"]].."/rim2")
			InitializeMiniMap("MinimapViewFrame", "Interface/AddOns/XMinimap/Textures/"..XMinimapSkin[XMinimapSet["Style"]].."/mask", "MinimapFramePlayerCursor", "MinimapFrameDuelRange", "MinimapFrame_Icon", 30)
		else
			DefaultSkin()
		end
...
function XMinimap.Toggle(key)
	...
	elseif key=="LBUTTON" then
		if MinimapFrame:IsVisible() then
			XMinimapFN:SetTexture("Interface/AddOns/XMinimap/Textures/map_shadow")
			MinimapFrame:Hide()
			MinimapViewFrame:Hide()
		else
			XMinimapFN:SetTexture("Interface/AddOns/XMinimap/Textures/map_normal")
			MinimapFrame:Show()
...
function XMinimap.OnShow()
	...
	for i, v in ipairs(frames) do
		...
		_G["XMinimapGUI1_"..v.."_XA_Text"]:SetText(XMinimap.Lang["Anchor"])
	end
	...
	XMinimapGUI1_XA_Text:SetText(XMinimap.Lang["Anchor"])
	XMinimapGUI1_Size_Text:SetText(XMinimap.Lang["Size"])
	XMinimapGUI1_Style_Text:SetText(XMinimap.Lang["Style"])
	XMinimapGUI1_Title_CB_Text:SetText(XMinimap.Lang["Zone"])
	XMinimapGUI1_Time_CB_Text:SetText(XMinimap.Lang["Time"])
	XMinimapGUI1_Coord_CB_Text:SetText(XMinimap.Lang["Coord"])
	...
	XMinimapTab_1:SetText(XMinimap.Lang["Tab1"])
	XMinimapTab_2:SetText(XMinimap.Lang["Tab2"])
end
...
function XMinimap.Save()
	...
	Print("|cffFFBB55XMinimap|r %s", XMinimap.Lang["Saved"])
	XMinimap.Var()
end
